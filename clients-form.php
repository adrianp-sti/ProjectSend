	...
	$(document).ready(function() {
		$("form").submit(function() {
			...
			?>
						...
						is_complete(this.add_client_form_pass_verify,'<?php echo $validation_no_pass_verify; ?>');
						...
						is_match(this.add_client_form_pass,this.add_client_form_pass_verify,'<?php echo $validation_match_pass; ?>');
